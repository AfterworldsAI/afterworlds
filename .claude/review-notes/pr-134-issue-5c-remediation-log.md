...
(`srd_table_inventory.json`, 676 logical tables incl. 16 multi-page) at logical-table
...
676 logical tables (16 page-spanning); whole-corpus concordance + table structural
consistency + independent inventory (676/676) + 6 canaries all pass; byte-for-byte
