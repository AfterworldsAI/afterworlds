...
def test_the_committed_artifact_extends_this_copy_by_the_batches_since() -> None:
    ...
    rewriting history. The Owner's acceptance of the two Proficiency batches
    made that three, so the claim is generalized rather than re-pinned to a
    single batch name, following ``test_cover_1_frozen_prior``.
