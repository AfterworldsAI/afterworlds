...
def test_schema_5_stays_pinned_as_the_source_of_a_registered_succession() -> None:
    ...
    This build declares schema 7. Schema 5's pin is unchanged, and what it names
    ...
    assert REPRESENTATION_SCHEMA_VERSION == SCHEMA_7_VERSION
    ...
    # And the step after it, so the chain from schema 5 is asserted whole.
